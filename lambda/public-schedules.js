...
exports.handler = async (event) => {
  ...
  console.log('Public schedules request:', { httpMethod, proxy, pathParts, eventId, scheduleId });
  ...
  try {
    ...
    if (httpMethod === 'GET' && eventId && !scheduleId) {
      console.log('Querying published schedules for eventId:', eventId);
      ...
      console.log('Found published schedules:', Items?.length || 0);
    ...
    if (httpMethod === 'GET' && eventId && scheduleId) {
      console.log('Getting specific schedule:', { eventId, scheduleId });
      ...
      if (!Item || !Item.published) {
        console.log('Schedule not found or not published');
        return {
          statusCode: 404,
          headers,
